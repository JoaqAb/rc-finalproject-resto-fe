...
const validationSchema = Yup.object().shape({
  user_name: Yup.string()
    ...
    .matches(/^[a-zA-ZÁÉÍÓÚáéíóúüÜñÑ]+$/, 'El nombre solo puede contener letras')
    .required('El nombre es requerido'),
    user_lastname: Yup.string()
    .min(2, 'El apellido debe tener al menos 2 caracteres')
    .max(20, 'El apellido debe tener menos de 20 caracteres')
    .matches(/^[a-zA-ZÁÉÍÓÚáéíóúüÜñÑ]+$/, 'El apellido solo puede contener letras')
              ...
              <Form className='formulario' ref={form} onSubmit={sendEmail} >
                ...
                <div className='mb-3'>
                  ...
                  <Field
                    ...
                    className={`form-control ${
                      errors.user_lastname && touched.user_lastname ? 'is-invalid' : ''
                    }`}
                    />
                  <ErrorMessage
                    name='user_lastname'
